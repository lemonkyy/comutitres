...
const mobileIcon =
  "flex h-7 w-10 items-center justify-center rounded-[6px] transition-[background-color,transform] duration-150";
const desktopIcon =
  "flex size-8 items-center justify-center rounded-[6px] transition-[background-color,transform] duration-150";
const responsiveIcon =
  "flex h-7 w-10 items-center justify-center rounded-[6px] transition-[background-color,transform] duration-150 md:size-8";
